      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-32 sm:pt-40 overflow-hidden bg-brand-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16" style={{ transformStyle: 'preserve-3d' }}>
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              Fill Every{' '}<br />
              <span className="text-brand-red">Classroom.</span>
            </motion.h1>
            ...
            >
              Data-driven admission campaigns for Schools, Colleges & Universities. 35% avg. enrollment growth.
            </motion.p>
            ...
            >
              ...
              >
                Get Admission Strategy <ArrowRight className="w-5 h-5" />
              </motion.a>
            </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-display font-bold text-brand-black">15k+</p>
                  <p className="text-xs text-brand-black/50 font-medium">Leads Generated</p>
                </div>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <p className="text-sm font-bold">35% Admission Growth</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
